      ...
      <div class="row">
        <div class="three fifth padded">
          <div class="bounceInLeft animated tablelike">
            ...
            <div class="equalize row">
              <div class="three seventh half-padded align-center asphalt-bg"></div>
              <div class="two seventh half-padded align-center asphalt-bg">Total Hari Kerja</div>
              <div class="two seventh half-padded align-center asphalt-bg"><?php echo $summary_attendance->sum_hari_kerja; ?></div>
            </div>
            <?php            
            } else {
            ?>
